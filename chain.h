...
public:
    ...
    * with the Node at pos2. The positions are 0-based.
	*
    ...
    * every second node between chains. Note: the first nodes 
	* swapped are those at index 1 (0-based). The length of 
